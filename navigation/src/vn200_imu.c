...
int VN200IMUInit(VN200_DEV *dev, char *devname, char *logDirName, int fs, time_t *initTime, unsigned key) {
    ...
    return VN200Init(dev, devname, logDirName, fs, VN200_BAUD, VN200_INIT_MODE_IMU, initTime, key);

} // VN200IMUInit(VN200_DEV *, char *, int)
...
} // VN200IMUPacketParse(unsigned char *, int, IMU_DATA *) {
